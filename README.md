...
- **Validação e treino da deteção** — `validator.py` (janela desktop nativa) percorre as amostras, mostra a deteção com zoom/pan, e aprende **recompensando e punindo parâmetros do detetor** forma a forma contra o guia manual; cada amostra recebe **estrelas automáticas (0–5)** e um slider de **avaliação manual**. O treino da CNN de deteção faz-se via interface manual.
